...
export default function ServicesModal() {
  return (
    <NavigationMenu className="left-12">
      <NavigationMenuList>
        <NavigationMenuItem>
          <NavigationMenuTrigger className="!bg-transparent p-0">Getting started</NavigationMenuTrigger>
          <NavigationMenuContent className="bg-green-400  md:w-[400px] lg:w-[1000px] xl:w-[1200px]">
